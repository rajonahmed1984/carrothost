...
import {
  Cpu, Shield, Zap, Globe, Clock, Headphones,
...
const plans = [
  ...
  },
  {
    ...
    price: "৳2,999",
    period: "/mo",
    description: "Best for growing businesses and production workloads",
    features: [
      "4 vCPU Cores (Xeon)",
      "8 GB DDR4 ECC RAM",
      "120 GB NVMe Storage",
...
const features = [
  {
    ...
    description: "Enterprise-grade Xeon CPUs with high clock speeds and multi-core performance for demanding workloads.",
  },
  {
    icon: Zap,
    title: "NVMe SSD Storage",
    description: "Ultra-fast NVMe drives deliver up to 10× faster I/O than traditional SSDs for blazing performance.",
  },
  {
    icon: Server,
    title: "KVM Virtualization",
    description: "Full hardware virtualization with dedicated resources — no overselling, no noisy neighbors.",
  },
  {
    icon: Shield,
    title: "DDoS Protection",
    description: "Enterprise-grade DDoS mitigation filters malicious traffic before it reaches your server.",
  },
  {
    icon: Lock,
    title: "Full Root Access",
    description: "Complete control over your server — install any software, configure any service, run any stack.",
  },
  {
    icon: RefreshCw,
    title: "Snapshot Backups",
    description: "Create and restore full server snapshots instantly. Roll back to any saved state in seconds.",
  },
  {
    icon: Gauge,
    title: "99.99% Uptime SLA",
    description: "Redundant power, networking, and cooling ensure maximum uptime for mission-critical applications.",
  },
  {
    icon: Globe,
    title: "Multiple OS Options",
    description: "Choose from Ubuntu, Debian, CentOS, AlmaLinux, Rocky Linux, Windows Server, and more.",
  },
  {
    icon: Database,
    title: "Scalable Resources",
    description: "Upgrade CPU, RAM, and storage on-demand without downtime or data migration.",
  },
];

const specs = [
  { label: "Processor", value: "Intel Xeon E-2388G / Gold 6230" },
  ...
  { label: "Network", value: "1 Gbps Dedicated Port" },
  { label: "IPv4", value: "1–3 Dedicated IPs" },
  { label: "IPv6", value: "/64 Subnet Included" },
  { label: "Operating Systems", value: "Linux / Windows Server" },
  { label: "Control Panel", value: "Optional (cPanel, Plesk)" },
  { label: "Data Center", value: "Singapore / Germany" },
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-[1.1] mb-6">
              <span className="text-foreground">Xeon-Powered</span>
              <br />
              <span className="text-gradient">Virtual Servers.</span>
            </h1>

            <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Enterprise Intel Xeon processors, NVMe storage, and KVM virtualization — dedicated resources with full root access for total control.
            </p>
            ...
            >
              {[
                { value: "Xeon", label: "Intel CPUs" },
                { value: "KVM", label: "Virtualization" },
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-5 text-gradient">
              Raw Power, Zero Compromise
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Dedicated Xeon resources with KVM isolation — built for applications that demand consistent, high performance.
            </p>
          </motion.div>
      ...
      <section id="pricing" className="section-spacing relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Dedicated resources at shared-hosting prices. Scale up anytime without downtime.
            </p>
          </motion.div>
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              The hardware and infrastructure behind every Xeon VPS.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-4">
                Deploy Your Xeon VPS Today
              </h2>
              <p className="text-primary-foreground/80 text-lg mb-8">
                Instant provisioning, full root access, and a 7-day money-back guarantee.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <motion.a
                  href="#pricing"
